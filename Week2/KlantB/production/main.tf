module "vpc" {
    ...
    vpc_name = "ProdVPCKlantB"
    vpc_cidr = "10.5.0.0/16"
    vpc_dns_support = true
    vpc_dns_hostnames = true
    subnet_cidr = "10.5.1.0/24"
    subnet_map_public_ip_on_launch = true
    subnet_name = "ProdPublicSubnetKlantB"
    gw_name = "ProdMainKlantB"
    routetable_name = "ProdRouteTableKlantB"
...
module "server" {
    ...
    instance_key_name = "rubenprodklantb"
    ...
    instance_name = "ServerProdKlantB"
}