module "vpc" {
    ...
    vpc_name = "ProdVPCKlantA"
    vpc_cidr = "10.1.0.0/16"
    vpc_dns_support = true
    vpc_dns_hostnames = true
    subnet_cidr = "10.1.1.0/24"
    subnet_map_public_ip_on_launch = true
    subnet_name = "ProdPublicSubnetKlantA"
    gw_name = "ProdMainKlantA"
    routetable_name = "ProdRouteTableKlantA"
...
module "server" {
    ...
    instance_name = "ServerProdKlantA"
}